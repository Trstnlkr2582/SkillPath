import { View, Text, Touchable, TouchableOpacity, useWindowDimensions, Platform } from 'react-native'
...
export default function SplashScreen() {
  ...
  return (
    <View style={{ ...basic.container, backgroundColor: "#ecfdfb" }}>
      <View style={{ ...basic.container, justifyContent: "flex-end", position: "absolute", height: Platform.OS != "web" ? height : "100%", width: Platform.OS != "web" ? width : "100%" }}>
        <Text style={basic.bottomText}>© 2026 SkillPath Professional Education. Todos los
      ...
      <View style={{ ...basic.container, flex: 0 }}>
        ...
        <TouchableOpacity
          style={{...basic.button, width: Platform.OS != "web" ? width*0.7 : "70%"}}
        ...
        <View style={{...basic.separator, width: Platform.OS != "web" ? width*0.7 : "70%"}} />
        <View style={{ flexDirection: isWide ? "row" : "column", alignContent: "center", justifyContent: "center"}}>
          ...
          <Text style={{ ...basic.title2, fontFamily: "Inter_500Medium", fontSize: 12, padding: 5, paddingTop: 5, alignSelf: "center"}}>Certificaciones Oficiales</Text>
          <Image source={"https://static.thenounproject.com/png/778835-200.png"} style={{...basic.icon, alignSelf: "center"}} />
          <Text style={{ ...basic.title2, fontFamily: "Inter_500Medium", fontSize: 12, padding: 5, paddingTop: 5, alignSelf: "center"}}>Rigor Académico</Text>
          <Image source={"https://static.thenounproject.com/png/778835-200.png"} style={{...basic.icon, alignSelf: "center"}} />
          <Text style={{ ...basic.title2, fontFamily: "Inter_500Medium", fontSize: 12, padding: 5, paddingTop: 5, alignSelf: "center"}}>Crecimiento Profesional</Text>
        </View>
